...
public class GradeController {
    ...
    @PreAuthorize ("hasRole('ADMIN') or (hasRole('TEACHER') and @securityRoleFilterUtil.ifTeacherLessonStudent(authentication, #gradeDTO.studentId))")
    @PostMapping (value = "/set-grades")
    public ResponseEntity<Void> setStudentGrades (@Valid @RequestBody GradeDTO gradeDTO) {
